# LIBRA-Data-Analytic-BeautifulSoup-Capstone
...
#### * Result  : Case1.py & Capstone Webscrapping using BeautifulSoup Case 1.ipynb

2. Data film yang rilis di tahun 2019 dari `imdb.com/search/title/?release_da
te=2019-01-01,2019-12-31`

    * Dari Halaman tersebut carilah `judul` , `imdb rating` , `metascore`, dan `votes`
    * Buatlah plot dari 7 film paling populer di tahun 2019.

#### * Result  : Case2.py & Capstone Webscrapping using BeautifulSoup Case 2.ipynb
